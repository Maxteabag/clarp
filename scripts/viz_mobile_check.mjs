...
try{
 for(const viewport of [{width:390,height:844},{width:320,height:568},{width:844,height:390}]){
  ...
  const pageUrl=new URL(url);pageUrl.searchParams.set('view','flow');
  await page.goto(pageUrl.href);await page.waitForFunction(()=>window.fleetWorldSnapshot?.().frames>5);
