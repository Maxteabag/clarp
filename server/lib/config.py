...
DEFAULT_ROSTER: dict[str, str] = {
    ...
    # Codex android roster (names and artwork recovered from the ALADDIN review).
    "Axel":   "12e85709-099c-480a-ba3e-875c41a9611a",
    "Iris":   "f6ff7c0c-e396-40a9-a70b-f7607edb6937",
    "Felix":  "1fcd23d0-bf12-4896-8f60-4f21ef5c9b98",
    "Gordon": "4b31d090-8d2d-4bcd-8a32-1c135301e26e",
    "Marsy":  "e8e5fffb-252c-436d-b842-8879b84445b6",
    "Tigo":   "f24ae0b7-a3d2-4dd1-89df-959bdc4ab179",
    "Wren":   "5a93ae96-9e3e-4b9d-8575-5f62b7de6d0f",
    "Lezo":   "30894953-bcce-41fe-892c-15ce19c843ff",
    "Vesper": "cfce9402-0067-458b-95a7-95846f469406",
    "Avana":  "efddb3d2-4464-45e0-9f8a-fcd5fd4fc54f",
    "Aura":   "daf747c6-6bc2-4083-bd59-aa94dce23f5d",
    "Orion":  "42b39f37-515f-4eee-8546-73e841679c1d",
    "Cipher": "565510e8-6b45-45de-8758-13588fbaec73",
    "Spectra":"59cb0f89-5d66-49f8-b965-f72b252789e0",
    "Solu":   "8b233a59-b1f4-42f2-895a-c9417ae41df8",
    "Lyra":   "9329fbdb-e285-4fba-95ec-592e15f14476",
    "Echo":   "eb7d0d3b-e427-483b-bbca-1c009c33f8a7",
    "Nova":   "f0377496-2708-4cc9-b2f8-1b7fdb5e1a2a",
    # Grok cartoon roster.
    "Margrok":"79f8b5fb-2cc8-479a-80df-29f7a7cf1a3e",
    "Roxy":   "c2ad7092-0447-47ea-948b-61fbb6faf153",
    "Vance":  "7e19344f-9f17-47d7-a13a-4366ad06ebf3",
    "Fang":   "db69127a-dbaf-4fa9-b425-2fe67680c348",
    "Riot":   "a01c369f-6d2d-4185-bc20-b32c225eab70",
    "Raven":  "ca566b43-944e-4474-b494-7d9f0695f307",
    "Jax":    "79d2cf27-444a-4c3a-9eed-2ad5cf795a3b",
    "Dagger": "5319c0b1-3dd1-4c00-b721-bfd2ec88ef56",
    "Blaze":  "a33f7a4c-100f-41cf-a1fd-5822e8fc253f",
    "Spike":  "ef191366-f52f-447a-a398-ed8c0f2943a1",
    # Gemini cartoon roster.
    "Pip":    "d6905573-8e91-4e32-b103-fd4d1205cd87",
    "Bloop":  "73693e3c-11ef-40e9-b5b7-786d790d562b",
...
# the artwork carries the visual identity while the prompt supplies behavior.
PERSONA_PERSONALITIES.update({
    "Axel": "Personality: a high-precision android engineer; terse, exact, and relentlessly practical.",
    "Iris": "Personality: an observant, empathetic android; perceptive, calm, and quietly inventive.",
    "Felix": "Personality: a friendly human/android fox archetype; clever, alert, and warmly direct.",
    "Gordon": "Personality: a patient elder android with a turtle's steadiness; deliberate, wise, and dependable.",
    "Marsy": "Personality: a welcoming mariposa android; bright, encouraging, and socially perceptive.",
    "Tigo": "Personality: a focused tiger android; energetic, courageous, and decisive under pressure.",
    "Wren": "Personality: a poised android with expressive external devices; curious, precise, and attentive.",
    "Lezo": "Personality: a humane lizard android; observant, adaptive, and gently unconventional.",
    "Vesper": "Personality: a cyber-noir debugger; direct, analytical, and skilled at navigating distributed state machines.",
    "Avana": "Personality: a raven-themed android; perceptive, composed, and drawn to hidden connections.",
    "Aura": "Personality: a luminous golden-honey android; warm, reassuring, and quietly radiant.",
    "Orion": "Personality: a battle android; disciplined, mission-focused, and protective.",
    "Cipher": "Personality: a hacker android; technically sharp, skeptical, and inventive without theatrics.",
    "Spectra": "Personality: an orca-inspired android; intelligent, collaborative, and calm with strong instincts.",
    "Solu": "Personality: a parrot-inspired African android; expressive, observant, and quick to connect ideas.",
...
class Config:
    ...
    oracle_delegation_strategy: str = "operator"
    oracle_router_reuse: bool = False
...
def load(path: pathlib.Path | None = None) -> Config:
    ...
    _CACHED = Config(
        ...
        local_enabled   = bool(network.get("local_enabled", False)),
        local_tls_port  = int(network.get("local_tls_port", 7683)),
        ...
        oracle_delegation_strategy = str(openai.get("oracle_delegation_strategy", "operator")).strip(),
        oracle_router_reuse = bool(openai.get("oracle_router_reuse", False)),
