...
class ToolExplanations:
    def __init__(self, *, translate=None, debounce=.18):
    ...
    def _work(self):
        while True:
            ...
            try:
                ...
                outcome = "ready"
            except Exception:  # Never include prompts, subprocess output or errors in logs.
                values = [{"status": "failed", "reason": "translator_failed"} for _ in requests]
                outcome = "failed"
