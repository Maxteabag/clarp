...
export function flowDemo(start){
  ...
  const events=[
    ...
    e(3,5,'edit',file,4),e(4,10,'test',test,4,'failed',builder,{validation:'test',validation_exact:true}),
    e(5,15,'edit',file,4),e(6,20,'test',test,4,'succeeded',builder,{validation:'test',validation_exact:true}),
  ...
  const work={synthetic:true,available:true,
    contract:{intent:'Synthetic plan declared by the Builder role.',evidence:'Synthetic events attributed by role and time.',outcome:'Synthetic artifacts with a generated placeholder preview.',handoff:'Synthetic message naming the plan.'},
    ...
    artifacts:[
      ...
      {id:'demo:artifact-run-1',type:'workflow_run',title:'Checks',status:'failed',agent_id:builder,agent:'Builder',session:'demo-builder',created_at:at(37),completed_at:at(38),
       run:{workflow_name:'Checks',repository:'example-owner/project',branch:'main',conclusion:'failure',github_status:'completed'},remote_target:remote},
      {id:'demo:artifact-video',type:'video',title:'Reload lab · comparison',status:'ready',agent_id:builder,agent:'Builder',session:'demo-builder',created_at:at(38.5),
       preview:{url:'demo:synthetic',mime:'image/png',width:192,height:144},media:{mime_type:'video/mp4',file_name:'comparison.mp4',duration_ms:12000}},
      {id:'demo:artifact-run-2',type:'workflow_run',title:'Checks',status:'completed',agent_id:builder,agent:'Builder',session:'demo-builder',created_at:at(40),completed_at:at(41.5),
       run:{workflow_name:'Checks',repository:'example-owner/project',branch:'main',conclusion:'success',github_status:'completed'},remote_target:remote},
    ],
    messages:[{id:'demo:message-1',from_agent_id:builder,from:'Builder',to_agent_id:reviewer,to:'Reviewer',session:'demo-reviewer',ts:at(43),plan_ids:[plan],
      excerpt:'Handing you the reload lab plan for the service restart and a final look.'}]};
